      ...
      <main className="w-[75%] h-screen flex items-center justify-center bg-black relative">
        <AnimatePresence mode="wait">
          {viewMode === 'list' ? (
            ...
            >
              <div className="columns-1 md:columns-2 lg:columns-3 gap-12 w-full space-y-12">
                {initialExperiments.map((exp, idx) => {
                  return (
                    <motion.div 
                      ...
                      className="break-inside-avoid border-t border-white/20 pt-2 mb-16 flex flex-col group"
                    >
